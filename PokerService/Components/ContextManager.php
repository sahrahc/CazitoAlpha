...
class Context {
	...
	public static function Init() {
		...
		$_SESSION['StatusDT'] = $currentDT;
		$_SESSION['StatusDTString'] = $currentDT->format($dateTimeFormat);
	...
	public static function GetStatusDTString() {
		if (isset($_SESSION['StatusDTString'])) {
			return $_SESSION['StatusDTString'];
		}
		return null;
	}
