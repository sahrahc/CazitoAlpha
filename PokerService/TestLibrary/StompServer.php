...
/**
 * DON'T USE. Queues on the server are created directly as AMQP, no need
 * for stomp 
 * 
 * Usage: This script processes user action on StompServer.html
 * 
 * Test creating a queue via php
